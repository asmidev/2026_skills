...
**Books List – 2026** — 2026-yil davomida o‘qilishi rejalashtirilgan, o‘qilayotgan va yakunlangan kitoblarni tizimli ravishda yuritish uchun mo‘ljallangan shaxsiy bilim loyihasi.

Bu repo — intizomli o‘qish, chuqur fikrlash va doimiy rivojlanish yo‘l xaritasi.

---

## 🎯 Asosiy maqsadlar

- 2026-yilda kamida **50+ sifatli kitob** o‘qish
- Har bir kitob bo‘yicha qisqa xulosa va muhim g‘oyalarni yozib borish
- O‘qish jarayonini shaffof va tartibli yuritish
- Shaxsiy bilim bazasini shakllantirish
...
├── README.md
├── finished/
│   └── o‘qib bo‘lingan kitoblar
│
├── reading/
│   └── hozir o‘qilayotgan kitoblar
│
├── planned/
│   └── rejalashtirilgan kitoblar
│
└── notes/
